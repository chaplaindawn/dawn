 ...
 */
function dawn_hide_acf_menu( $show ) {
...
add_filter( 'acf/settings/show_admin', 'dawn_hide_acf_menu' );
 ...
 */
function dawn_yoast_meta_order() {

    return 'low';

}
add_filter( 'wpseo_metabox_prio', 'dawn_yoast_meta_order' );
 ...
 */
function dawn_hide_yoast_columns() {
...
add_action( 'init', 'dawn_hide_yoast_columns' );
